...
@Data
@AllArgsConstructor
public class EffectFastActionActivity {
    ...
    public static class RequestBody {
        @Element(name = "EffectFastActionActivity")
        Data data;
    }
    ...
    public static EffectFastActionActivity create(Data data) {
        RequestBody requestBody = new RequestBody(data);
        return new EffectFastActionActivity(requestBody);
    }
}
