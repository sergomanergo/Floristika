...
@Data
@AllArgsConstructor
public class AddUpdateGoodItemAuth {
    ...
    public static class RequestBody {
        @Element(name = "AddUpdateGoodItemAuth")
        Data data;
    }
    ...
    public static AddUpdateGoodItemAuth create(Data data) {
        RequestBody requestBody = new RequestBody(data);
        return new AddUpdateGoodItemAuth(requestBody);
    }
}