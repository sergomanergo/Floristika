...
@Data
@NoArgsConstructor
public class AddUpdateOrderResponse implements XmlFormated, PotentialErrorsProvider {
    @Element(name = "Body")
    ...
    public static class RequestBody {
        @Element(name = "AddUpdateOrderPhotoAuthResponse")
        Response response;
    }
    ...
    public static class Response {
        @Element(name = "AddUpdateOrderPhotoAuthResult")
        Content content;
    }
